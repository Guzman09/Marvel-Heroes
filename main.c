...
main()
{
    ...
    if ((friends + beatles >= baseball) &&
        ...
        {
            printf("The cast of Firends and the Beatles ");
    ...
    {
        printf("Neither can happen-- too many books or moies,\n");
    ...
    {
        printf("\nThere are more baseball and basketabll players\n");
        printf("combied than football players.");
    }
